...
const getDashboardDetails = async (req, res) => {
    let date = new Date();
    let m = date.getMonth();
    let lastMonthFstDay = new Date(date.getFullYear(), m - 1, 1);
    let lastMonthLstDay = new Date(date.getFullYear(), m, 1);
    let thisMonthLstDay = new Date(date.getFullYear(), m + 1, 1);
